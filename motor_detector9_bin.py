...
datadir = '/home/hongbin/data/motor_sound_data/1s_bin_dataset/'
mode = 'train'
...
def fully_connected_bn(layer_name, prev_layer, num_units, is_bn_training=True, epsilon=1e-3, decay=0.90, stddev=0.05, wl=0.):
    ...
    with tf.name_scope(layer_name):
        ...
        with tf.name_scope('weights'):
            fc_w = variable_with_weight_2loss([in_num_units, num_units], stddev, wl)
...
conv_layer_bn3 = conv_layer_bn('conv_layer_bn3', conv_layer_bn2, 8, 7, strides=1, padding='VALID', is_bn_training=is_training,
                               epsilon=1e-3, decay=0.99)
print('conv_layer_bn3: ', conv_layer_bn3)
...
fully_connected_bn1 = fully_connected_bn('fully_1', flat, 100, is_bn_training=is_training, epsilon=1e-3,
                                         decay=0.99, wl=0.004)
